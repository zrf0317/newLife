...
<div id="right" >
  ...
  <form action="/newLife/index.php/Admin/Index/addnote" method="post" onsubmit="return lbyz(this)" >
    <table width="670" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td  bgcolor="#666666"><table width="670" cellspacing="1" border="0px">
            <tr>
              <td width="103"  bgcolor="#FFFFFF"><div>帖子标题:</div></td>
              <td width="560"  bgcolor="#FFFFFF"><input type="text" name="title" /></td>
            </tr> 
            <tr>
              <td width="103"  bgcolor="#FFFFFF"><div>板块:</div></td>
              <td width="560"  bgcolor="#FFFFFF"><select name="forumID"><?php if(is_array($forum)): $i = 0; $__LIST__ = $forum;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$forum): $mod = ($i % 2 );++$i;?><option value="<?php echo ($forum["id"]); ?>"><?php echo ($forum["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?></select></td>
            </tr>
            <tr>
             <td width="103"  bgcolor="#FFFFFF"><div>帖子内容:</div></td>
              <td width="560"  bgcolor="#FFFFFF"><textarea name="content" cols="" rows="" style=" margin-left:10px; width:350px; height:200px;"></textarea></td>
            </tr>
             <tr>
              <td colspan="4"  bgcolor="#FFFFFF"><input type="submit" name="ok" value="增加帖子&nbsp;" style="width:55px; height:30px;" />                              <div></div></td>
            </tr>         
          </table></td>
      </tr>
    </table>
