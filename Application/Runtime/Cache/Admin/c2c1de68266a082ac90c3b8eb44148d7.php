      ...
      <tr>
        <td  bgcolor="#666666"><table width="670" cellspacing="1" border="0px">
            <tr>
              ...
              <td width="33"  bgcolor="#FFFFFF"><div>帖子ID</div></td>
              <td width="115"  bgcolor="#FFFFFF"><div>评论用户</div></td>
              <td width="59"  bgcolor="#FFFFFF"><div>评论内容</div></td>
              <td width="77"  bgcolor="#FFFFFF"><div>评论日期</div></td>
              <td width="77"  bgcolor="#FFFFFF"><div>回复用户ID</div></td>
			...
			<?php if(is_array($comment)): $i = 0; $__LIST__ = $comment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$comment): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td bgcolor="#FFFFFF"style="text-align:center;"><?php echo ($comment["noteid"]); ?></td>
              <td bgcolor="#FFFFFF"style="text-align:center;"><?php echo ($comment["username"]); ?></td>
              <td bgcolor="#FFFFFF"style="text-align:center;"><?php echo ($comment["content"]); ?></td>
              <td bgcolor="#FFFFFF"style="text-align:center;"><?php echo ($comment["date"]); ?></td>
			  <td bgcolor="#FFFFFF"style="text-align:center;"><?php echo ($comment["replyid"]); ?></td>
              <td bgcolor="#FFFFFF" style="text-align:center;"><a href= "/newLife/index.php/Admin/Index/deletecomment/commentid/<?php echo ($comment["id"]); ?>">删除</a></td>
